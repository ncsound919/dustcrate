...
// BinaryData is generated by CMake juce_add_binary_data from assets/
// It will contain VelumStroke_ttf when VelumStroke.ttf is placed in assets/fonts/
#if defined(JUCE_MODULE_AVAILABLE_juce_core)
  // BinaryData header is auto-included via JuceHeader.h when using juce_add_binary_data
#endif
...
private:
    ...
    DustCrateLookAndFeel laf;
    // Velum Stroke typeface for hip-hop header branding.
    // Loaded from BinaryData::VelumStroke_ttf (compiled in via juce_add_binary_data).
    // Falls back to "Courier New" bold if the TTF binary is not present.
